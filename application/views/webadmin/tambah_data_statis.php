...
<div class="TabView" id="TabView1">
    ...
    <!--Pages-->
		<div class="Pages">
			<!--Page 1-->
			<div class="Page">
				<?php echo form_open_multipart('webadmin/simpandatastatis');?>
					<table height="100%">
						<tr>
							<td>Kategori :<br />
								<select name="data_id" class="input">
									...
									?>	
								</select><input type="hidden" value="<?php echo $judul; ?>" name="judul" />
							</td>
						</tr>
						<tr>
							<td>Isi Data:<br />
						...
						<tr>
							<td><input type="submit"  value="Simpan Data" class="tombol"/></td>	
						</tr>
					</table>
				</form>
			</div>
