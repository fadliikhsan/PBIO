...
<div class="TabView" id="TabView1">
			...
			<table height="100%">
				...
				<tr>
					<td>Isi Berita :<br />
						...
						<input type="hidden" name="tipe" value="tutorial" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<input type="submit"  value="Simpan Data" class="submitButton2"/>
					</td>	
				</tr>
			</table>
			</form>
	...
	foreach($imglist->result_array() as $im)
	{
		?>	<tr bgcolor='#D6F3FF'>
				...
				<td><a href='<?php echo base_url()."index.php/webadmin/hapusmedia/".$im['id_file'];?>' onClick="return confirm('Anda yakin ingin menghapus data ini?')" title='Hapus File'>
